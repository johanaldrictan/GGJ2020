...
public class SFXManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Play sound with tag name with only pitch modulation
    /// </summary>
    ...
    /// <summary>
    /// Play sound with tag name with only volume modulation
    /// </summary>
    /// <param name="name"></param>
    ...
    /// <summary>
    /// Play sound with tag name with BOTH modulations
    /// </summary>
    /// <param name="name"></param>
    ...
    /// <summary>
    /// Play sound with tag name with clip randomization
    /// </summary>
    /// <param name="name"></param>
    ...
    /// <summary>
    /// Play with all the randomizations
    /// </summary>
    /// <param name="name"></param>
    public void PlayRandomWithMod(string name)
    {
        Sound s = GetSFX(name);
        if (s == null)
            return;
